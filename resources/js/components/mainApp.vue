        ...
        <div v-if="islogged" >
            ...
            <div class="_1side_menu" >
                ...
                <div class="_1side_menu_list">
                    ...
                    <li><router-link to="admin"><Icon type="ios-speedometer" /> Admin users</router-link></li>
                    <li><router-link to="roles"><Icon type="ios-speedometer" /> Role Management</router-link></li>
                    ...
                    <li><router-link to="test_vuex"><Icon type="ios-speedometer" /> test</router-link></li>
...
export default {
    ...
    /*beforeCreate(){
        console.log('show date before create :',this.name);
    },
    created(){
        console.log('show date  create :',this.name);
    },
    mounted(){
        console.log('show date  mounted :',this.name);
    }*/
